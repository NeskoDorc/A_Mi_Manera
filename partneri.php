        ...
        background-repeat: no-repeat; "></i></a>
            ...
            <div class="container">
              <div class="partneri" style="padding-top: 10vh; ">
                ...
                <div class="naslov"><h2 class="ime" style="padding-bottom: 0px;"><?php echo $lang['tatjana'] ?>
                   </h2>
                   
                   <h2 style="color: black; padding-bottom: 5vh; ">  <?php echo $lang['pos'] ?></h2>
                </div>


              
              <div class="tekst"><p style="text-align: center;"><?php echo $lang['tattext'] ?></p></div>
            ...
            <div class="container" >
                <div class="partneri" style="padding-top: 10vh;">
                  ...
                  <div class="naslov"><h2 class="ime" style="padding-bottom: 0px;"><?php echo $lang['nebojsa'] ?>
                    
                     </h2>
  
                     <h2 style="color: black; padding-bottom: 5vh;"><?php echo $lang['posNe'] ?></h2>
                  </div>
  
  
                
                <div class="tekst"><p  style="text-align: center;"><?php echo $lang['nettext'] ?>
            ...
            <div class="container" style="padding-bottom: 10vh; padding-top: 0px i !important;">
                <div class="partneri" style="padding-top: 10vh;">
  
  
                
  
                  <div class="naslov"><h2 class="ime" style="padding-bottom: 0px;"><?php echo $lang['zoran'] ?>
                    
                    
                     </h2>
  
                     <h2 style="color: black; padding-bottom: 5vh;"> <?php echo $lang['posZo'] ?></h2>
                  </div>
  
  
                
                <div class="tekst"><p  style="text-align: center;"><?php echo $lang['zottext'] ?>
